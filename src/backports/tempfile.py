...
from backports.os import fsencode as _fsencode

from tempfile import gettempdir as _gettempdir, _get_candidate_names
...
def gettempdir():
    tempdir_ = _gettempdir()
    try:
        # This should try fs encoding, etc
...
def _sanitize_params(prefix, suffix, dir):
    ...
    print('_sanitize_params input ', prefix, suffix, dir)
    ...
    if dir is None:
        if output_type is unicode:
            ...
            dir = gettempdirb()
    print('_sanitize_params returning ', output_type)
